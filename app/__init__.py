...
app.register_blueprint(comment_routes, url_prefix='/api/<int:cheatsheetId>/comments')
app.register_blueprint(step_routes, url_prefix='/api/<int:cheatsheetId>/steps')
